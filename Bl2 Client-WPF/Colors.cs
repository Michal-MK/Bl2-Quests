...
namespace Bl2Client {
	public static class Colors {
		...
		public static readonly SolidColorBrush BOUNTY_BOARD = new(Color.FromRgb(100, 100, 100));
		...
		public static readonly SolidColorBrush TINY_TINA = new(Color.FromRgb(220, 160, 0));
		...
		public static SolidColorBrush GetColor(string name) {
			return (SolidColorBrush)typeof(Colors).GetField(name.ToUpper().Replace(' ', '_'))!.GetValue(null)!;
		}
	}
}
